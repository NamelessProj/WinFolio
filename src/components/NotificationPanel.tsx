...
const NotificationPanel: React.FC<Props> = ({isOpen, setIsOpen, notifications, handleClearNotifications}) => {
    return (
        <ClickOutside isOpen={isOpen} setIsOpen={setIsOpen}>
            <div id="notification-panel" className={`absolute bottom-7 right-2.5 w-[325px] bg-[rgba(25,25,25,0.7)] backdrop-blur-xl text-white rounded-md transform translate-x-[350px] ${isOpen ? '!translate-x-0' : ''} transition-transform duration-200 ease-in-out`}>
